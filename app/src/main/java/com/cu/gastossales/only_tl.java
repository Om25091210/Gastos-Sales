...
public class only_tl extends AppCompatActivity {

    ActivityOnlyTlBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityOnlyTlBinding.inflate(getLayoutInflater());
        ...
        Fresco.initialize(
                only_tl.this,
                ImagePipelineConfig.newBuilder(only_tl.this)
        ...
        LinearLayoutManager mManager = new LinearLayoutManager(only_tl.this);
        ...
        binding.logout.setOnClickListener(v->{
            auth.signOut();
            startActivity(new Intent(only_tl.this , Splash.class));
            finish();
        });

        binding.textView81.setOnClickListener(v->{
            Intent intent=new Intent(only_tl.this,calendar_data.class);
    ...
    private void get_the_data() {
        reference_ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                sales_provider_Adapter sales_provider_adapter=new sales_provider_Adapter(list,only_tl.this);
